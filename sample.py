...
#hugo = Employee.Employee(3, 'Hugo', 'Morales', '4567890123', True)
#print(seth)

#EmployeeSQL.createSQLRecord(seth)
#EmployeeSQL.displayRecord(1)
#print(EmployeeSQL.deleteSQLRecord(17))

#EmployeeSQL.createSQLRecord(gustavo)
#EmployeeSQL.createSQLRecord(hugo)

#EmployeeSQL.displayTable()

#seth.setEmpManager(True)
#EmployeeSQL.updateSQLRecord(seth)
#EmployeeSQL.displayRecord(1)
